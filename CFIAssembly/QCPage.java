...
//	private String[] options, userDefined;
	...
	public QCPage(Stage primaryStage, File FastQCLocation, File BBToolsLocation) {
		this.primaryStage = primaryStage;
		this.FastQCLocation = FastQCLocation;
		this.BBToolsLocation = BBToolsLocation;
//		this.options = new String[]{"Threads"};
//		this.userDefined = new String[] {"3"};
	}
...
//Aka fastq, sam, and bam files. 
	...
	private class FastQCTask extends Task<Void>{
		...
		protected Void call() {
			...
			String fullProcessCall = processCall + " " + readDirectory + "\\" + file.getName();
			try {
